                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/index.php?link=timex">ارسال تایمکس پزشکان</a></li>
                            <li><a class="dropdown-item" href="#">ارجاعات داخلی</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/index.php?link=units">مراکز بازرسی</a></li>
                            <li><a class="dropdown-item" href="/index.php?link=regions">مناطق بازرسی</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/index.php?link=geoloc">موقعیت جغرافیایی</a></li>
                            <li><hr class="dropdown-divider"></li>
