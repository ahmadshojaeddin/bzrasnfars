...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE setad.inspections SET f02_komitehfanni_json=? WHERE id=?;");
...
try {
    ...
    // update jsonString in the inspections table
    $stmt = $conn->prepare("SELECT f02_komitehfanni_json, st.name_ as state_name, date_, insst.desc_ as status_desc 
...
<head>
    ...
    <script type="text/javascript">
        ...
        function submit_json(jsonString, showAlert) {
            ...
            fetch('/setad/php/inspections/forms/f02-komitehfanni.php', {
