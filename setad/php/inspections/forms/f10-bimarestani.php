...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE setad.inspections SET f10_bimarestani_json=? WHERE id=?;");
...
try {
    ...
    $stmt = $conn->prepare("SELECT f10_bimarestani_json, st.name_ as state_name, date_, insst.desc_ as status_desc 
...
<head>
    ...
    <script type="text/javascript">
        ...
        function submit_json(jsonString, showAlert) {
            ...
            fetch('/setad/php/inspections/forms/f10-bimarestani.php', {
